...
public class ATMTest {
	...
	public void testTakeOut2() {
		...
		assertEquals (s1.getHundries(), 4);
		assertEquals (s1.getFifties(), 3);
		assertEquals (s1.getTwenties(), 2);
		
		assertEquals (s2.getHundries(), 1);
		assertEquals (s2.getFifties(), 0);
